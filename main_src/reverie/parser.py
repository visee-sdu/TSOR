...
def parse_args():
    ...
    parser.add_argument('--output_dir', type=str, default='./datasets/REVERIE/exprs_map/finetune/exp2', help='experiment id')
    ...
    parser.add_argument('--world_size', type=int, default=1, help='number of gpus')  # GPU的数量
    parser.add_argument('--local_rank', type=int, default=-1)  # 当前GPU的编号
    parser.add_argument("--node_rank", type=int, default=0, help="Id of the node")  # 当前节点的编号
    ...
    # parser.add_argument("--multi_endpoints", default=True)
    ...
    parser.add_argument('--bert_ckpt_file', 
                        default=None, help='init vlnbert')
    ...
    # parser.add_argument('--enc_full_graph', default=True)
    parser.add_argument('--graph_sprels', action='store_true', default=False)
    # parser.add_argument('--graph_sprels', default=True)
