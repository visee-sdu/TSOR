...
class VLNBert(nn.Module):
    ...
    def forward(self, mode, batch):
        ...
        if mode == 'language':            
            txt_embeds, n_embeds, token_embeds = self.vln_bert(mode, batch)
            return txt_embeds, n_embeds, token_embeds  # 16*46*768
            ...
            return pano_embeds, pano_masks  # 16*50*768, 16*50
